...
// import imgWorkCover from "../../assets/image/portfolio/renfe-cover.png";
// import imgS1 from "../../assets/image/jpg/details/details-12.jpg";
import imgS1 from "../../assets/image/portfolio/tmb/tmb-project.png";
import imgS2 from "../../assets/image/portfolio/tmb/tmb-prototype.gif";
        ...
        <Section hero>
          <Container>
            <Row className="justify-content-center text-center">
              <Col lg="8">
                <Box>
                  <Text variant="tag">UI/UX DESIGN</Text>
                  <Title className="my-4">
                    Barcelona Metro <br /> Transport App
                  </Title>
                  <Text
                    variant="p"
                    css={`
