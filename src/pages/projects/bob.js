...
import imgWorkCover from "../../assets/image/portfolio/bob/bob-cover.png";
import imgS1 from "../../assets/image/portfolio/bob/1-1024x576.png";
import imgS2 from "../../assets/image/portfolio/bob/2-1024x576.png";
import imgS3 from "../../assets/image/portfolio/bob/3-1024x576.png";
import imgS4 from "../../assets/image/portfolio/bob/4-1024x576.png";
        ...
        <Section hero>
          <Container>
            <Row className="justify-content-center text-center">
              <Col lg="8">
                <Box>
                  <Text variant="tag">PRODUCT DESIGN</Text>
